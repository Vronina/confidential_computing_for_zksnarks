...
#    echo $file
    if [ -f "$file" ]; then 
        ...
        mv process_top.txt process_top_compile_$file_name.txt
        mv cpu_top.txt cpu_top_compile_$file_name.txt
        ...
        mv process_top.txt process_top_witness_$file_name.txt
        mv cpu_top.txt cpu_top_witness_$file_name.txt
        ...
        mv process_top.txt process_top_export_$file_name.txt
        mv cpu_top.txt cpu_top_export_$file_name.txt
